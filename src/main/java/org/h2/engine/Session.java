...
public class Session extends SessionWithState {
    ...
    //wuwei add for save tableSchema map (store the table schema)
    private HashMap<String, Table> tableSchemaMap;
    
    public HashMap<String, Table> getTableSchemaMap()
    {
        return tableSchemaMap;
    }

    public void setTableSchemaMap(HashMap<String, Table> tableSchemaMap)
    {
