...
public class Parser {
    ...
    //wuwei add for not right check.
    private boolean rightsChecked=true;
    ...
    private TableFilter readTableFilter(boolean fromOuter) {
        ...
        //wuwei revised not checked.
        return new TableFilter(session, table, alias, true,
                currentSelect);
    }
    ...
    /**
     * wuwei revised for parse table schema
     * 
     */
...
/**
        ...
        **/
        ...
        //wuwei add for build the table schema
        Table mytable=session.getTableSchemaMap().get(tableName);
        if(mytable!=null)
        {
            return mytable;
        }
