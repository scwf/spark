...
import org.apache.spark.sql.hive.{HiveFunctionWrapper, HiveGenericUdtf, ExtendedHiveQlParser, NativePlaceholder}
import org.apache.spark.sql.catalyst.huawei._
...
private[hive] object HiveQLParser {
