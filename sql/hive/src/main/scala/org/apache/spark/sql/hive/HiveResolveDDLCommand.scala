...
import org.apache.spark.sql.hive.execution.{CreateMetastoreDataSourceAsSelect, CreateMetastoreDataSource}

object HiveResolveDDLCommand extends Rule[LogicalPlan] {
